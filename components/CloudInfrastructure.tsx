...
import { Cloud, Link2, ShieldCheck, type LucideIcon } from "lucide-react";
import FadeIn from "./FadeIn";

type CloudItem = { name: string; description: string };

const ICONS: LucideIcon[] = [Cloud, ShieldCheck, Link2];

export default async function CloudInfrastructure() {
  const t = await getTranslations("CloudInfra");
  const items = t.raw("items") as CloudItem[];
